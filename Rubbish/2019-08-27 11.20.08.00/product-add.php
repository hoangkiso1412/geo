					...
					<div class="col-sm-3">
						<div class="input-group mt-1">
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input" name="favorite" id="copy_address">
					...
					<div class="col-sm-4">
						<div class="input-group">
							...
							<input type="text" name="product_tax" class="form-control"
								...
								aria-describedby="sizing-addon1" onkeypress="return isNumber(event)"><span
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input type="text" placeholder="BarCode Numeric Digit 123112345671"
							class="form-control margin-bottom" name="barcode" onkeypress="return isNumber(event)">
